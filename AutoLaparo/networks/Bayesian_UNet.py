...
class BDL_L_UNet(nn.Module):
    def __init__(self, in_chns, class_num):
        ...
        self.fc_mu = nn.Linear(256 * 15 * 30, 256)
        self.fc_var = nn.Linear(256 * 15 * 30, 256)
        self.transform = nn.Linear(256, 256 * 15 * 30)
        self.sigmoid = nn.Sigmoid()


        # P(SXZ) = P(S|XZ) * P(X|Z) * P(Z)
    ...
    def forward(self, x, sample_time):
        ...
        z_ = self.transform(z).view(-1, 256, 15, 30) # 240/16=15, 480/16=30
